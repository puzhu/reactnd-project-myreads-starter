...
class BookShelf extends Component {
    ...
    render() {
        ...
        const rawShelves = [...new Set(books.map(book => book.shelf))] 
        
        const cleanShelves = rawShelves.map(shelf => shelf
                 ...
                 <div className="bookshelf" key={shelf}>
                    ...
                    <div className="bookshelf-books">
                        <ol className="books-grid">
                          {
                            books.filter(book => book.shelf === rawShelves[i])
                              .map(book => {
                                return (
                                    <li key={book.title}>
                                      <div className="book">
